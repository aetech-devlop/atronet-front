...
import type {
  ...
  PostDailyReportsResponse,
  PostHourlyReportsResponse,
  PostCacheClearResponse,
  PostCacheInvalidateDateRangeResponse,
  PostCacheInvalidateStationResponse,
} from './types';
...
export const useGetCacheStatus = (options?: UseQueryOptions<GetCacheStatusResponse>) => {
  return useQuery({
...
export const useGenerateDailyReports = () => {
  return useMutation<PostDailyReportsResponse, Error, GenerateDailyReportsParams>({
    mutationFn: (params: GenerateDailyReportsParams) => statsApi.generateDailyReports(params),
  });
};

export const useGenerateHourlyReports = () => {
  return useMutation<PostHourlyReportsResponse, Error, GenerateHourlyReportsParams>({
...
export const useClearCache = () => {
  return useMutation<PostCacheClearResponse, Error, void>({
    mutationFn: () => statsApi.clearCache(),
  });
};

export const useInvalidateDateRangeCache = () => {
  return useMutation<PostCacheInvalidateDateRangeResponse, Error, { start_date: string; end_date: string }>({
...
export const useInvalidateStationCache = () => {
  return useMutation<PostCacheInvalidateStationResponse, Error, { station_id: string }>({
